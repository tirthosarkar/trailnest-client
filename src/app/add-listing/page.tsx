...
const AddListingPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await serverMutation("/listing", formData, "POST");
      toast.success("🎉 Listing added successfully!", {
        description: "Your listing is now live and ready for bookings.",
        duration: 4000,
      });
      ...
      toast.error("Failed to add listing", { description: errorMessage });
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          <SectionTitle
            ...
            subtitle="Share your campsite spaces or outdoor gear with the community"
            center
          />
          ...
          <div className="mt-8 rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Image URL with Next.js Image Preview Frame */}
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-(--dark)">
              ...
              {/* Features/Amenities Grid Selection */}
              ...
              {/* ✅ Relocated: Pinpoint Location Coordinates now at the Bottom */}
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-(--dark)">
              ...
              {/* Full Width Submit Button Wrapper */}
              <div className="pt-2">
                <Button
                  type="submit"
                  variant="primary"
